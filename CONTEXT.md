...
5. **alert()/confirm() → inline confirmations** in the shopping list and admin (audit item G; `ShoppingList.js` «Εκκαθάριση λίστας;» uses `confirm`).
6. After decision #1 (consent-free measurement): build 3c. (Decision #2 is done — row 23.)
